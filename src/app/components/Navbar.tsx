        ...
        <div className="w-14 bg-white h-screen border-r border-[#ECEEF1] fixed overflow-hidden">
            <nav className="flex flex-col h-[100%] justify-between">
                ...
                <ul className="flex flex-col justify-center items-center w-full ">
                    ...
                    {routesConfig.map((route) => (
                        <li key={route.path} className="my-1">
                            <NavLink to={withPublicUrl(cleanPath(route.path))} className="flex justify-center items-center">
                ...
                <div className="mb-4 flex flex-col justify-center items-center">
                    ...
                    <NavLink to={withPublicUrl("/settings")} className="flex justify-center items-center my-2">
